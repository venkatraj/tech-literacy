...
if( ! class_exists('Tech_Literacy_Customizer_API_Wrapper') ) {
	class Tech_Literacy_Customizer_API_Wrapper {
		...
		public static function getInstance($options) {
			if(! self::$_instance) {
				self::$_instance = new Tech_Literacy_Customizer_API_Wrapper($options);
			}
		...
		public function add_control($wp_customize, $field_id, $field_details) {
			...
			switch ($type) {
				...
				case 'icons-picker':
					$wp_customize->add_control( 
						new Tech_literacy_Icon_Customizer_Icon_Picker_Control(
							$wp_customize, 
							$field_id,
							array(
								'label' => isset($label) ? $label : '',
